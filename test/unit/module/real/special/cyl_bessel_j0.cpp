   ...
   <typename T>(T const& a0)
{
  ...
  TTS_ULP_EQUAL(eve__cyl_bessel_j0(v_t(10)), std__cyl_bessel_j0(v_t(10))  , 1.5);
  TTS_ULP_EQUAL(eve__cyl_bessel_j0(v_t(5)),  std__cyl_bessel_j0(v_t(5))   , 1.5);
  TTS_ULP_EQUAL(eve__cyl_bessel_j0(v_t(2)),  std__cyl_bessel_j0(v_t(2))   , 1.5);
  ...
  TTS_ULP_EQUAL(eve__cyl_bessel_j0( T(10)) ,  T(std__cyl_bessel_j0( v_t(10)) ), 1.5);
  TTS_ULP_EQUAL(eve__cyl_bessel_j0( T(5))  ,  T(std__cyl_bessel_j0( v_t(5))  ), 1.5);
  TTS_ULP_EQUAL(eve__cyl_bessel_j0( T(2))  ,  T(std__cyl_bessel_j0( v_t(2))  ), 1.5);
  ...
  TTS_ULP_EQUAL(eve__cyl_bessel_j0( T(1))  ,  T(std__cyl_bessel_j0( v_t(1))  ), 2.5);
  TTS_ULP_EQUAL(eve__cyl_bessel_j0( T(0))  , eve::one(eve::as< T>()), 0.0);


  TTS_RELATIVE_EQUAL(eve__cyl_bessel_j0(a0), map(std__cyl_bessel_j0, a0), 0.001);
};
