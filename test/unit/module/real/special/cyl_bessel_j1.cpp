   ...
   <typename T>(T const& a0)
{
  ...
  auto std__cyl_bessel_j1 =  [](auto x)->v_t { return std::cyl_bessel_j(v_t(1), x); };
  ...
  TTS_ULP_EQUAL(eve__cyl_bessel_j1(v_t(10)), std__cyl_bessel_j1(v_t(10))  , 20.5);
  TTS_ULP_EQUAL(eve__cyl_bessel_j1(v_t(5)),  std__cyl_bessel_j1(v_t(5))   , 1.5);
  TTS_ULP_EQUAL(eve__cyl_bessel_j1(v_t(2)),  std__cyl_bessel_j1(v_t(2))   , 1.5);
  ...
  TTS_ULP_EQUAL(eve__cyl_bessel_j1(v_t(1)),  std__cyl_bessel_j1(v_t(1))   , 2.5);
  TTS_ULP_EQUAL(eve__cyl_bessel_j1(v_t(0)),  std__cyl_bessel_j1(v_t(0))   , 2.5);

  TTS_ULP_EQUAL(eve__cyl_bessel_j1( T(10)) ,  T(std__cyl_bessel_j1( v_t(10)) ), 20.5);
  TTS_ULP_EQUAL(eve__cyl_bessel_j1( T(5))  ,  T(std__cyl_bessel_j1( v_t(5))  ), 1.5);
  TTS_ULP_EQUAL(eve__cyl_bessel_j1( T(2))  ,  T(std__cyl_bessel_j1( v_t(2))  ), 1.5);
  ...
  TTS_ULP_EQUAL(eve__cyl_bessel_j1( T(1))  ,  T(std__cyl_bessel_j1( v_t(1))  ), 2.5);
  TTS_ULP_EQUAL(eve__cyl_bessel_j1( T(0))  ,  T(std__cyl_bessel_j1( v_t(0))  ), 2.5);


  TTS_RELATIVE_EQUAL(eve__cyl_bessel_j1(a0), map(std__cyl_bessel_j1, a0), 0.001);
};
