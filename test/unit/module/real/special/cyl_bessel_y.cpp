...
//   }
  ...
  {
//     TTS_ULP_EQUAL(eve__cyl_bessel_y(v_t(0), v_t(0)), v_t(boost_cyl_bessel_y(0.0, 0.0)), 10);
//     TTS_ULP_EQUAL(eve__cyl_bessel_y(v_t(1), v_t(0)), v_t(boost_cyl_bessel_y(1.0, 0.0)), 10);
//     TTS_ULP_EQUAL(eve__cyl_bessel_y(v_t(2), v_t(0)), v_t(boost_cyl_bessel_y(2.0, 0.0)), 10);
...
// //     TTS_ULP_EQUAL(eve__cyl_bessel_y(v_t(0.1), v_t(1)), v_t(boost_cyl_bessel_y(0.1, 1.0)), 10);
// //     TTS_ULP_EQUAL(eve__cyl_bessel_y(v_t(0), v_t(10)), v_t(boost_cyl_bessel_y(0.0, 10.0)), 10);
    TTS_ULP_EQUAL(eve__cyl_bessel_y(v_t(0), v_t(1)), v_t(boost_cyl_bessel_y(0.0, 1.0)), 10);
    TTS_ULP_EQUAL(eve__cyl_bessel_y(v_t(1), v_t(1)), v_t(boost_cyl_bessel_y(1.0, 1.0)), 10);
    TTS_ULP_EQUAL(eve__cyl_bessel_y(v_t(2), v_t(1)), v_t(boost_cyl_bessel_y(2.0, 1.0)), 10);
